        ...
        <MDBJumbotron className="mw-100" style={{ padding: 0, margin: 0 }}>
            <MDBCol className="text-black text-center" style={{ backgroundImage: `url(${sunset})` }}>
                <MDBCol className="py-5">
                    <MDBCardTitle className="h1-responsive pt-3 m-5 font-bold" style={{fontSize: "2rem"}}>Hello World,</MDBCardTitle>
                    {/* <div className="juicy-peach-gradient color-block-5 w-100 d-inline-block mb-3 bio"> */}
                        <p className="ml-5 bio" style={{fontSize: "1.5rem"}}>
                            I'm an aspiring fullstack web developer in SLC, UT and enjoy the diverse landscapes here.<br></br> I <MDBIcon icon="heart" /> hikes and biking around the city. I'll be adding some more projects to my portfolio as I continue to learn code.
                        </p>
                    {/* </div> */}
                    <Link to="/portfolio">
